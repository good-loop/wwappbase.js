...
const Advertiser = {
    ...
    'charity-small-print': "#advertiser > div > div > div.form > div.Card.panel.panel-warning > div.panel-body > div.container-fluid > div > div:nth-child(1) > div > div:nth-child(8) > input",
    'charity-circle-crop-factor': "#advertiser > div > div > div.form > div.Card.panel.panel-warning > div.panel-body > div.container-fluid > div > div:nth-child(1) > div > div:nth-child(9) > input",
...
const Advert = {
    ...
    name: '#advert > div > div:nth-child(2) > div > div:nth-child(7) > input',
    campaign: '#advert > div > div:nth-child(2) > div > div:nth-child(8) > input',
    logo: '#advert > div > div:nth-child(2) > div > div.CardAccordion > div:nth-child(1) > div.panel-body > div:nth-child(1) > div > input',
    'white-logo': '#advert > div > div:nth-child(2) > div > div.CardAccordion > div:nth-child(1) > div.panel-body > div:nth-child(2) > div > input',
    about: '#advert > div > div:nth-child(2) > div > div.CardAccordion > div:nth-child(1) > div.panel-body > div:nth-child(6) > textarea',
    video: '#advert > div > div:nth-child(2) > div > div.CardAccordion > div:nth-child(5) > div.panel-body > div:nth-child(1) > input',
    'mobile-video': '#advert > div > div:nth-child(2) > div > div.CardAccordion > div:nth-child(5) > div.panel-body > div:nth-child(4) > input',
};

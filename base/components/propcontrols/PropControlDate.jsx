 ...
 * @returns 
 */
function PropControlDate2({ prop, type, storeValue, rawValue, setRawValue, value, onChange, saveFn, set, time, ...otherStuff }) {
	...
	return <FormControl type="date" name={prop} value={rawValue} onChange={onChangeDate} {...otherStuff} />;
}

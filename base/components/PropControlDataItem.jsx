			...
			<Col md={4}>
				{pvDI.value && 
					(notALink? 
						...
						: <a href={"/#"+(navpage||itemType.toLowerCase())+"/"+encURI(pvDI.value.id)} title={"Switch to editing this "+itemType}><SlimListItem type={itemType} item={pvDI.value} noClick={false} /></a>
					)
				}
